...
class JunitNumExpressionsTest {
	...
	void test1() throws IOException, CheckstyleException {
		...
		File file = new File(filePath + "NumExpressionsTest1.java");
		...
		System.out.println("NumExpression Check 1 Done!");
	}
	...
	void test2() throws IOException, CheckstyleException {
		// Build File
		String filePath = "src/test/java/CategoryBTestFiles/";
		File file = new File(filePath + "NumExpressionsTest2.java");
		FileText ft = new FileText(file,"UTF-8");
		FileContents fc = new FileContents(ft);
		...
		System.out.println("NumExpression Check 2 Done!");
	}
